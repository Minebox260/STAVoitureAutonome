    ...
    switch (code) {
      case 105: 
       ...
       //generates the trajectory and stores it in params
        ...
        data->params->END_OF_LINE_X = atoi(strtok(NULL,":"));
        data->params->END_OF_LINE_Y = atoi(strtok(NULL,":"));
        struct Point * mission = (struct Point *)(malloc(sizeof(struct Point)));
        mission->x = data->params->END_OF_LINE_X;
        mission->y = data->params->END_OF_LINE_Y;
